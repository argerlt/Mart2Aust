% ---------- %
% Run of first 10 with 2000 mart, 1e-4 X, 1e-4 func
...
% ---------- %
% Run of first 10 with 2000 mart, 1e-2 X, 1e-2 func
% Tasks(1).options.OR_ksi =  [ 2.9603    7.8067    8.2472];
% Tasks(2).options.OR_ksi =  [3.1346    7.9507    8.3569];
% Tasks(3).options.OR_ksi =  [6.0296    9.5100    9.6920];
% Tasks(4).options.OR_ksi =  [2.7838    8.4558    8.7465];
% Tasks(5).options.OR_ksi =  [2.7607    9.1053    9.2832];
% Tasks(6).options.OR_ksi =  [5.4170    9.2921   10.1364];
% Tasks(7).options.OR_ksi =  [3.0772    7.7402    8.2131];
% Tasks(8).options.OR_ksi =  [4.7471    8.7561    8.7571];
% Tasks(9).options.OR_ksi =  [2.9342    8.1165    8.5029];
% Tasks(10).options.OR_ksi = [3.2428    9.3875    9.5835];
% Tasks(1).options.OR_noise =  0.0275;
% Tasks(2).options.OR_noise =  0.0282;
% Tasks(3).options.OR_noise =  0.0523;
% Tasks(4).options.OR_noise =  0.0327;
% Tasks(5).options.OR_noise =  0.0381;
% Tasks(6).options.OR_noise =  0.0489;
% Tasks(7).options.OR_noise =  0.0298;
% Tasks(8).options.OR_noise =  0.0564;
% Tasks(9).options.OR_noise =  0.0284;
% Tasks(10).options.OR_noise = 0.0345;

% ------
% Run of first 5 with 2000 mart, 1e-4 X, 1e-4 func
% Run 6 is close up of area from 2021 paper
% Run 7 is the full searchable area
